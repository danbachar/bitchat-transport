...
class UDXTransport implements Transport {
  ...
  Future<TransportConn> _performDial(
    ...
    try {
      ...
      final localMa = MultiAddr('${isIPv6 ? '/ip6' : '/ip4'}/${rawSocket.address.address}/udp/${rawSocket.port}/udx');
      final remoteMa = addr;
  ...
  Future<Listener> listen(MultiAddr addr) async {
    ...
    try {
      ...
      final boundMa = MultiAddr('${isIPv6 ? '/ip6' : '/ip4'}/${rawSocket.address.address}/udp/${rawSocket.port}/udx');
